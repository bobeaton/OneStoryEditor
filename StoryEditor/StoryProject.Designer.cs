        ...
        public partial class MemberDataTable : global::System.Data.TypedTableBase<MemberRow> {
            ...
            public MemberRow AddMemberRow(string name, string memberType, string memberKey, string email, string altPhone, string phone, string bioData, string skypeID, string teamViewerID, string OverrideVernacularKeyboard, string OverrideNationalBTKeyboard, string HgUsername, string HgPassword, MembersRow parentMembersRowByMembers_Member) {
                ...
                if ((parentMembersRowByMembers_Member != null)) {
                    columnValuesArray[13] = parentMembersRowByMembers_Member[0];
                }
