    ...
    public static string TestHelper(Item []f) {
      ...
      return (ret.ToString());
        ...
        private static int[] DiffCharCodes(string aText, bool ignoreCase)
        {
            ...
            int[] Codes = new int[aText.Length];
        ...
        protected const string CstrAdditionSpanPrefix = "<span style='text-decoration:underline; text-underline:single; color:red;'>";
        protected const string CstrDeletionSpanPrefix = "<span style='text-decoration:line-through; color:red;'>";
        protected const string CstrSpanSuffix = "</span>";

        /// <summary>
        /// returns HTML that represents the Track Changes of the difference between two string transfer objects.
        /// See http://www.mathertel.de/Diff/DiffTextLines.aspx for how this was worked out
        /// </summary>
        /// <param name="stOrig">original string transfer</param>
        /// <param name="stNew">new string transfer (new as in will get a red underlined for new bits and strike out for removed bits)</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// returns HTML that represents the Track Changes of the difference between two strings.
        /// See http://www.mathertel.de/Diff/DiffTextLines.aspx for how this was worked out
        /// </summary>
