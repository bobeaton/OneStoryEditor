...
namespace OneStoryProjectEditor
{
    ...
    public partial class StoryEditor : Form
    {
        ...
        private void UpdateRecentlyUsedLists(StoryProject.ProjSettings projSettings)

        public void UpdateRecentlyUsedLists(string strProjectFolder, string strProjectName)
        {
        ...
        protected Button AddDropTargetToFlowLayout(int nVerseIndex)
        {
            ...
            buttonDropTarget.Location = new Point(3, 3);
            buttonDropTarget.Name = CstrButtonDropTargetName + nVerseIndex.ToString();
            buttonDropTarget.Size = new Size(this.Panel1_Width, 10);
